...
<li>Garantie sur le hardware de la mécatronique (avant ou après clonage)</li>
  ...
  options: [
    ...
    },
    {
      ...
      type: 'text',
      required: false,
      placeholder: 'Ex : 0AM 927 769 D, 02E 927 770 AH, 0B5 927 156 K…',
      helpText: 'Référence imprimée sur l\'étiquette autocollante de la mécatronique (commence par 0AM, 02E, 0GC, 0BH, 0DD, 0B5, 0CJ ou 0BZ). Facultatif mais accélère le traitement.',
      priceDeltaCents: 0,
      choices: [],
    },
    {
