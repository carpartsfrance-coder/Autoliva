...
async function postAdminCreateProduct(req, res, next) {
  ...
  try {
    ...
    const form = {
      ...
      accessorySkus: getTrimmedString(req.body.accessorySkus),
    ...
    const accessorySkus = parseLinesToArray(form.accessorySkus);
  ...
  try {
    ...
    return res.render('admin/product', {
      ...
      form: {
        ...
        accessorySkus: Array.isArray(product.accessorySkus) ? product.accessorySkus.filter(Boolean).join('\n') : '',
